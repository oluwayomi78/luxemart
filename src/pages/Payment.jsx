...
const PaymentPage = () => {
    const {
        ...
        cartLoading,
        savePaymentMethod, 
        paymentMethod: paymentMethodFromContext 
    } = useCart();

    const [paymentMethod, setPaymentMethod] = useState(paymentMethodFromContext || 'PayPal');
                    ...
                    <div className="bg-white p-8 rounded-lg shadow-md">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mt-8 text-right">
                                <button
                                    type="submit"
                                    className="bg-gray-900 text-white py-3 px-8 rounded-md font-semibold hover:bg-gray-800 transition-colors"
                                >
                                    Continue to Review
                                </button>
                            </div>
